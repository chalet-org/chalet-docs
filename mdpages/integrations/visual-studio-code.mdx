...
[Visual Studio Code](//code.visualstudio.com/) is a cross-platform code editor with support for a vast array of extensions. For convenience, there's an official Chalet extension designed to make working with it inside of VS Code fast and easy.
