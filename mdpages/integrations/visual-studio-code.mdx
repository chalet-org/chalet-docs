...
The files are generated to `build/.project/.vscode` as not clash with any existing files that may be checked-in. You would then want to copy this folder to the root of your project and open that path in Visual Studio Code.
