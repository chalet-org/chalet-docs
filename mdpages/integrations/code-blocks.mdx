...
[Code::Blocks](//www.codeblocks.org/) is an open-source IDE that supports multiple compilers, but most commonly, you would use it with MinGW on Windows.
