...
To open it, this requires an Xcode install. You cannot use Command Line Tools with this. Any edits done in the `chalet.json` file will require the Xcode project to be re-exported.
