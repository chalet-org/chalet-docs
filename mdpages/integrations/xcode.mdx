...
> Note: There is a known issue right now (v0.6.7) where if you build inside of Xcode, and then use the xcodebuild strategy, a rebuild will get triggered. This will get addressed in the future.
