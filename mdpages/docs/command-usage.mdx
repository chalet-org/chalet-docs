...
| vscode | Visual Studio Code JSON format (launch.json, tasks.json, c_cpp_properties.json) |
...
| toolchain-presets | The list of toolchain presets available on the platform (See `chalet build --help`) |
...
| schema-chalet-json | The entire [build file](/docs/the-build-file) schema in JSON format |
| schema-settings-json | The entire `.chaletrc` / `.chalet/config.json` schema in JSON format |
| state-chalet-json | State applicable to the [build file](/docs/the-build-file) for the current project in JSON format |
| state-settings-json | State applicable to the [settings file](/docs/the-settings-file) for the current project in JSON format |
